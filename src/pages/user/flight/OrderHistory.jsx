      ...
      {isLoading ? (
        <div className="h-screen flex justify-center items-center">
          <div className="flex flex-row gap-2">
            <div className="w-4 h-4 rounded-full bg-[#2A629A] animate-bounce"></div>
            <div className="w-4 h-4 rounded-full bg-[#2A629A] animate-bounce [animation-delay:-.3s]"></div>
            <div className="w-4 h-4 rounded-full bg-[#2A629A] animate-bounce [animation-delay:-.5s]"></div>
          </div>
        </div>
      ) : (
        <div>
              ...
              <div className="flex flex-col lg:flex-row justify-center gap-14 overflow-hidden">
                ...
                <div className="lg:w-2/5">
                  ...
                  <div className="w-full">
                    {selectedTicket?.status === "ISSUED" && (
                      <button className="mt-4 w-full inline-flex justify-center rounded-xl border-0 shadow-sm py-3 bg-[#2A629A] font-medium text-white hover:bg-[#003285] focus:outline-none focus:ring-0">
                        Cetak Tiket
                      </button>
                    )}
                    {selectedTicket?.status === "UNPAID" && (
                ...
                <div className="p-5 pt-0">
                  <div className="flex flex-col">
                    ...
                    {userRecentSearches.map((search, index) => (
                      <div
                        className="mt-5 flex justify-between border-b-2"
                        key={index}
                      >
                        <p>{search?.query}</p>
                        <button
