                        ...
                        <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                            <div className="sm:flex sm:items-start">
                                ...
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                    <h3 className="text-lg leading-6 text-[#003285] font-semibold" id="modal-headline">
                                        Detail Penerbangan
                                    </h3>
                                    <div className="flex flex-row gap-3">
                                        <div className="flex flex-col justify-between items-center">
                                            <div className="flex flex-col text-center mt-1.5">
                                                ...
                                                <div className="text-sm">
                                                    {new Date(selectedFlight?.flight_date).toLocaleString("id-ID", {
                                                        day: "2-digit",
                                                        month: "long",
                                                        year: "numeric",
                                                    })}
                                            ...
                                            <div className="pt-12">
                                                <span className="text-sm">
                                                    <time>{selectedFlight?.duration}</time>
                                                </span>
                                            </div>
                                            <div></div>
                                            <div className="flex flex-col text-center mt-1.5">
                                        ...
                                        <div>
                                            <ol className="relative border-s border-gray-200">
                                                <li className="mb-5 ms-4">
                                                    ...
                                                    <h3 className="text-lg font-semibold">
                                                        {selectedFlight?.departure_city} ({selectedFlight?.departure_code})
                                                    </h3>
                                                    <p className="text-sm">{selectedFlight?.departure_airport}</p>
                                                    <p className="mb-4 text-sm">{selectedFlight?.departure_terminal}</p>
                                                </li>
                                                <li className="mb-5 ms-4 border border-gray-300 rounded-lg p-4">
                                                    ...
                                                    <div className="flex gap-5 md:gap-20 my-3 flex-col md:flex-row">
                                                        {selectedFlight?.baggage ? (
                                                            <div className="flex gap-3">
                                                                ...
                                                                <div className="gap-1 flex flex-col">
                                                                    <p className="text-sm">Kabin : {selectedFlight?.cabin_baggage} kg</p>
                                                                    <p className="text-sm">Bagasi : {selectedFlight?.free_baggage} kg</p>
                                                                </div>
                                                            </div>
                                                        ) : (
                                                            ""
                                                        ...
                                                        <div className="flex gap-3">
                                                            ...
                                                            <div>
                                                                <p className="text-sm">{selectedFlight?.airplane_model}</p>
                                                                <p className="text-sm">
                                                                    {selectedFlight?.flight_entertaiment ? "Hiburan di pesawat" : ""}
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <li className="ms-4">
                                                    <div className="absolute w-3 h-3 bg-[#2A629A] rounded-full mt-1.5 -start-1.5 border border-white"></div>
                                                    <h3 className="text-lg font-semibold">
                                                        {selectedFlight?.arrival_city} ({selectedFlight?.arrival_code})
                                                    </h3>
                                                </li>
                                            </ol>
                                            ...
                                            <div className="ms-4">
                                                ...
                                                <p className="text-sm">{selectedFlight?.arrival_terminal}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
