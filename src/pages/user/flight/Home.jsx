            ...
            <div className="pt-64 md:pt-52 pb-12 ">
              <div className="grid grid-cols-1 md:grid-cols-2 md:gap-6 lg:gap-0">
                ...
                <div className="flex flex-col justify-center">
                  ...
                  <p className="md:w-3/4">
                    Ingin pesan tiket pesawat murah? Kini hanya dengan satu
                    sentuhan jari, kamu bisa langsung pesan tiket pesawat murah
                    di BiFlight.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col items-center max-w-screen-xl text-center">
                ...
                <p className="mb-8 text-lg font-normal lg:text-xl sm:px-16 lg:px-48 ">
                  Jelajahi berbagai kemungkinan perjalanan domestik dengan
                  BiFlight. Nikmati kemudahan dan kenyamanan dalam memesan tiket
                  pesawat murah untuk penerbangan domestik.
                </p>
              </div>
            </div>
          </div>
